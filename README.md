...
情報保障システム工学・演習 第11回「機械学習の活用」で使用したソースコード一式を公開します。
このプロジェクトは、MediaPipe Hand Landmarkを使ってWebカメラから手のランドマーク（関節）をCSVで出力するものです。  
...
```
git clone https://github.com/yuki-untitled/HandLandmarksToCSVRecorder.git
```
...
- downloadsを押すと自動的にCSVファイルがダウンロードされます。
- 1-01から始まり、1-20まで終わると、次は2-01から始まります。
- 1〜9それぞれの指文字のデータを20個ずつ集めることができます。
- 1-01を0-01や10-01にすることで、0や10の指文字も収集することができます。
